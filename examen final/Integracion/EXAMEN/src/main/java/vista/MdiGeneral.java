...
public class MdiGeneral extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        bodegavista = new javax.swing.JMenuItem();
        ...
        bodegavista.setText("Mantenimiento Bodega");
        bodegavista.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bodegavistaActionPerformed(evt);
            }
        });
        MenuMantenimientos.add(bodegavista);
...
//        
    ...
    private void bodegavistaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bodegavistaActionPerformed
         MantenimientoBodega ventana = new MantenimientoBodega();
       jDesktopPane1.add(ventana);
      Dimension desktopSize = jDesktopPane1.getSize();
      Dimension FrameSize = ventana.getSize();
     ventana.setLocation((desktopSize.width - FrameSize.width) / 2, (desktopSize.height - FrameSize.height) / 2);
    }//GEN-LAST:event_bodegavistaActionPerformed
    ...
    private javax.swing.JMenuItem bodegavista;
